    ...
    ngAfterViewInit(): void {
        ...
        .forEach((xx,ii)=>{ // just becuase massive refactoring will take place so lets be gentle and use xx ii instead of x i
            ...
            */
            ...
            let mainResizeEvent =combineLatest([
                mainResizeObservable$,
                ryber.appCO0.metadata.ryber.sectionDefault.app.width.mediaQuerySubject
            ])
            .subscribe((stuff)=>{
                ...
                // if thres something to format format it
                // console.log(formatZChild,zChild)
                if(Object.keys(formatZChild).length !== Object.keys(zChild).length - 2){
                //

                    // console.log(appTV,moving)
    ...
    private desktopMediaQuery(devObj:{zChild: any, keep: any[], finalKeep: any[], finalZChildKeys: any[], finalAlign: any[], section: any, ref: ChangeDetectorRef, align: any[], topLevelZChild: any, moving: any, ryber: RyberService, appTV: any}) {
...

        {

            {
                ...
                //
                // try{
                //     console.log(finalAlign,appTV)
                //     Array.from(finalAlign[0], (x, i) => { return 'f'; })
                // }catch(e){
                //     console.log("finalAlign was not properly setup")
                // }
                keep = finalKeep;
                let stackObj = {
                    ...
                    heightInclude: [null,
                        ...Array.from(finalAlign[0], (x, i) => { return 'f'; }),
                         ...Array.from(flatDeep(finalAlign.slice(1), Infinity), (x, i) => { return 't'; })]
                };
